  ...
  return (
    ...
    >
      <Link to={`/listing/${listing._id}`}>
        <img
          src={listing.imageUrls[0] || "https://t4.ftcdn.net/jpg/04/73/72/11/360_F_473721132_I9LNMCvx7Du6EdJNH91EywcNHzgtEclz.jpg"}
          alt="listing cover"
        ...
        <div className="p-3 flex flex-col gap-2 w-full">
          ...
          <div className="text-slate-700s flex gap-4">
